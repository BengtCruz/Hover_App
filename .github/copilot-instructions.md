...
1. **App Startup Flow**:
   - Launch app → Splash screen → Welcome screen → Phone auth screen
...
2. **Home Screen Functionality**:
   ...
   - Tap on map to set destination marker
...
4. **Location Services**:
   ...
   - Verify current location marker appears on map
   - Test destination marker placement
...
- `lib/features/home/presentation/pages/home_page.dart` - Main map interface
- `pubspec.yaml` - Dependencies and configuration
- `analysis_options.yaml` - Linting rules

### Dependencies Overview
- **flutter_bloc**: State management (^8.1.6)
- **go_router**: Navigation (^14.2.7)
- **google_maps_flutter**: Maps integration (^2.9.0)
